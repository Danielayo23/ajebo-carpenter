...
export default function OrderStatusActions({
  ...
  return (
    <form action={action} className="flex items-center justify-end gap-2 flex-nowrap">
  ...
  <button
    ...
    className="shrink-0 rounded bg-[#04209d] px-2 py-1 text-xs font-semibold text-white disabled:opacity-50"
  >
    Save
  </button>
</form>
